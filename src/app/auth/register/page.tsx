...
export default function RegisterPage() {
  ...
  async function onSubmit(data: RegisterForm) {
    ...
    if (!res.ok) {
      ...
      toast({ title: "Registration failed", description: err.error || "Please try again.", variant: "destructive" });
      return;
    }
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
          ...
          <p className="text-sm text-zinc-500 mb-6">Start your trading journal today</p>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-zinc-900 px-2 text-zinc-600">or sign up with email</span>
            </div>
          </div>
